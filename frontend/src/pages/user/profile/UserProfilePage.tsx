...
const UserProfilePage: React.FC = () => {
  ...
  const handlePasswordChange = async (e: FormEvent) => {
    ...
    if (!validatePasswordStrength(newPassword)) {
      setPasswordError(
        'Password must be at least 8 characters long, including uppercase and special characters'
      )
      return
    }
    ...
    try {
      ...
      showSuccess(hasPassword ? 'Password updated successfully.' : 'Password set successfully.')
